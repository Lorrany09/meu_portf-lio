...
const contatos = [
    {
        nome: "GitHub",
        link: "https://github.com/Lorrany09",
        svg: `<svg fill="currentColor" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        nome: "Linkedin",
        link: "https://www.linkedin.com/in/lorrany-queiroz-88824b315/",
        svg: `<svg fill="currentColor" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
...
function fazendoCards() {
    ...
    const div2 = document.getElementById('contatos');
    ...
    contatos.forEach(({nome, link, svg}) => {
        const card2 = document.createElement("a");

        card2.href = link;
        card2.target = "_blank";
        card2.rel = "noopener noreferrer";
        card2.innerHTML = `
                ${svg}
            <span>${nome}</span>
        `;

        card2.classList.add("cardContato");
